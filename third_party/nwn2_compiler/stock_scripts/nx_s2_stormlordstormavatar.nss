...
//:://////////////////////////////////////////////
//:: AFW-OEI 03/21/2007: repurposed for the 1/day
//::	Stormlord ability.  Uses character level
//::	instead of caster level for duration,
//::	and is automatically "Extended" (x2 duration).
...
//Major variables
	...
	float 	fDuration	=	RoundsToSeconds(2*GetTotalLevels(oCaster, TRUE));	// Use all character levels instead of caster level.
