// Minimal archive-derived activity/animation reference layer for the first
// BLACKSMITH/GATE_POST/TRADER WORK/SLEEP vertical slice.
// Source: legacy ambientlivev2 `scripts/ambient_life/al_acts_inc.nss`.
// Values below preserve the legacy activity IDs and animation strings for the
// currently used work/sleep/guard/trader groups only.
...
const int DL_ARCH_ACT_NPC_MERCHANT_MULTI = 38;
const int DL_ARCH_ACT_NPC_GUARD = 43;
