...
- **Следующий шаг по Task 3.2:** расширить сценарные perf-проверки fairness до нагрузочных профилей с длительным starvation-окном и fault-injection на pause/resume.
