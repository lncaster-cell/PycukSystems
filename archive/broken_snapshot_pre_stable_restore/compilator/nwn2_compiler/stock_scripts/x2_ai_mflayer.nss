...
//:://////////////////////////////////////////////
// ChazM 8/22/06 - fix for interface change of GetSubRace()
...
int  GetMindFlayerTactics(object oTarget)
{
   ...
   else if (GetIsPlayableRacialType(oTarget) && MFGetTargetConditionSucks(oTarget) || GetSubRace(oTarget)== RACIAL_SUBTYPE_TIEFLING)
   {
        nRet =  2;
   }
