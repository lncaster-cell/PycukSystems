...
// ChazM 8/31/06 changed constant EFFECT_TYPE_IMPROVEDINVISIBILITY to EFFECT_TYPE_GREATERINVISIBILITY 
...
int StartingConditional()
{
    ...
    nEff = nEff || GetHasEffect(EFFECT_TYPE_GREATERINVISIBILITY,oPC);
